...
1. Download the workflow file to your project:
   ```sh
   curl -o .agent/workflows/create-project-rules.md \
     https://raw.githubusercontent.com/naravid19/ai-project-rules-generator/main/.agent/workflows/create-project-rules.md
   ```
