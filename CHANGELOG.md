...
- **Cross-file consistency check** — ensures `.cursorrules`, `AGENTS.md`, and `README.md` don't contradict each other
...
- Quick Reference Card updated to reflect v2.0 features
...
[Unreleased]: https://github.com/naravid19/ai-project-rules-generator/compare/v2.0.0...HEAD
[2.0.0]: https://github.com/naravid19/ai-project-rules-generator/compare/v1.2.0...v2.0.0
